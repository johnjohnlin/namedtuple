...
struct S35 {
	string miheffhflnkegngklhdjjlejaealn;
	string enndkbjkfdnfaddidl;
	unsigned eghhdmkalfhihfk;
	unsigned bdiljbcbmhhjmeigdc;
	unsigned ciimlhbijfambki;
	long bbkefnhbggkdminmea;
	long ibgceljinaingekh;
	int* ellilnlbhcfljm;
	string bhffclekdm;
	long hefddnhhamlidhcnbmi;
	S30 jaibnijcblakmiifmfklehmlgjbkf;
	S27 mbnkdedbbhlbif;
	S30 nikgkggnkincngcfgidjlb;
	S6 gkkhkbclhkncjedkcdljkggdfkede;
	S13 hblkmjkadndnmd;
MAKE_NAMEDTUPLE(miheffhflnkegngklhdjjlejaealn,enndkbjkfdnfaddidl,eghhdmkalfhihfk,bdiljbcbmhhjmeigdc,ciimlhbijfambki,bbkefnhbggkdminmea,ibgceljinaingekh,ellilnlbhcfljm,bhffclekdm,hefddnhhamlidhcnbmi,jaibnijcblakmiifmfklehmlgjbkf,mbnkdedbbhlbif,nikgkggnkincngcfgidjlb,gkkhkbclhkncjedkcdljkggdfkede,hblkmjkadndnmd)
};
struct S36 {
	float glafiidiakjmnifccekcggfgd;
	unsigned iiadddkcfcakelejgffcfeljmej;
	float bfbadenbngbhemkcgeb;
	int* dlgfflacfmnhnkfgnifeg;
	float ggceflafankcnkeiialgbkkh;
	string kbhihnhgkfccnmhfflc;
	unsigned bhlhaciadmggijbceh;
	int* fhdgakijabamihdaebljf;
	int* nbgkcinllfagcdahdhbidme;
	int* jhglidncgn;
	S6 bdgeaikbabc;
	S25 mgngfbchfakibikghfaaj;
	S2 jgmneideeliemfgelgnnk;
	S11 maaeghfiabhhebaiikf;
	S11 nahlgejmldnh;
MAKE_NAMEDTUPLE(glafiidiakjmnifccekcggfgd,iiadddkcfcakelejgffcfeljmej,bfbadenbngbhemkcgeb,dlgfflacfmnhnkfgnifeg,ggceflafankcnkeiialgbkkh,kbhihnhgkfccnmhfflc,bhlhaciadmggijbceh,fhdgakijabamihdaebljf,nbgkcinllfagcdahdhbidme,jhglidncgn,bdgeaikbabc,mgngfbchfakibikghfaaj,jgmneideeliemfgelgnnk,maaeghfiabhhebaiikf,nahlgejmldnh)
};
struct S37 {
	string dcdblhidea;
	unsigned fjcamnfjkjndfemjbfkijhdfnij;
	long dgjfkiljfmkddklfemfnkhbkg;
	int* gjdhendlencfniacklccgn;
	float jkhliiekdlmbgglknhfjkdfjfi;
	long hjgbhhkkhnhjbgkeleknjff;
	long ejjcifjblghgnbhjn;
	float kbbkcambdidnhmafcmennhmgecbe;
	float hnggkmjnnkblhdlidelikcldmj;
	string fhdhcdmhlajneg;
	S11 gafbafeicmald;
	S31 ejakkjcfnggbiaaddaclalfma;
	S11 aeljlmndanjcgiiljgfembgbcb;
	S27 hiffedemedkdilmdlbbkcgbcbbjid;
	S34 hkffhdhndenbciemednehliinlchi;
MAKE_NAMEDTUPLE(dcdblhidea,fjcamnfjkjndfemjbfkijhdfnij,dgjfkiljfmkddklfemfnkhbkg,gjdhendlencfniacklccgn,jkhliiekdlmbgglknhfjkdfjfi,hjgbhhkkhnhjbgkeleknjff,ejjcifjblghgnbhjn,kbbkcambdidnhmafcmennhmgecbe,hnggkmjnnkblhdlidelikcldmj,fhdhcdmhlajneg,gafbafeicmald,ejakkjcfnggbiaaddaclalfma,aeljlmndanjcgiiljgfembgbcb,hiffedemedkdilmdlbbkcgbcbbjid,hkffhdhndenbciemednehliinlchi)
};
struct S38 {
	unsigned nkhlgndhilcm;
	long ecdndggknh;
	int* abnfbfbknkjg;
	long ahnigbkcgm;
	unsigned gibebekkmnkfjblnfjim;
	unsigned fenbmnddla;
	string keahhambcnbehmhajff;
	unsigned ldhmcmaelchlhgndn;
	float eggjjiekfkjchbnckimkdhfci;
	unsigned bckgebllfhfkbdifbmdmnbh;
	S10 fieigfnjhkdhbilbdagkcn;
	S18 khamifejmcfamhljdemfenjain;
	S5 jhcedldkihbgndkkhcjimiciinm;
	S34 jlnjmenkhelndjegnjlhnighdcbhbh;
	S23 makfimmmbghdecbdgmmabbhkejc;
MAKE_NAMEDTUPLE(nkhlgndhilcm,ecdndggknh,abnfbfbknkjg,ahnigbkcgm,gibebekkmnkfjblnfjim,fenbmnddla,keahhambcnbehmhajff,ldhmcmaelchlhgndn,eggjjiekfkjchbnckimkdhfci,bckgebllfhfkbdifbmdmnbh,fieigfnjhkdhbilbdagkcn,khamifejmcfamhljdemfenjain,jhcedldkihbgndkkhcjimiciinm,jlnjmenkhelndjegnjlhnighdcbhbh,makfimmmbghdecbdgmmabbhkejc)
};
struct S39 {
	float gbfgenbbhlcclmacdeckkhjndf;
	string fimcfggkfdhakhbbdgjllggbfan;
	float nfflhmmhbhnbabjlbi;
	float nkggbefkgm;
	string kkjdclkeffl;
	int* blhncmagcjemagkadgbglgff;
	string gmacjlhgaehclnkckcmfjbfdid;
	float lmkalafbkhbdfakhhekidadbg;
	string edeheggnehehjfnngbbncdjfdmggj;
	string gkjbgehgealkmedkchbhaki;
	S37 lnfibnkhfjdmblaea;
	S9 icjhkjalmnimalcjdina;
	S18 lgjbkmajnnihdmchcmc;
	S4 fbigabggegggjckjkknn;
	S21 haacangamkmejcemdininaekicnijm;
MAKE_NAMEDTUPLE(gbfgenbbhlcclmacdeckkhjndf,fimcfggkfdhakhbbdgjllggbfan,nfflhmmhbhnbabjlbi,nkggbefkgm,kkjdclkeffl,blhncmagcjemagkadgbglgff,gmacjlhgaehclnkckcmfjbfdid,lmkalafbkhbdfakhhekidadbg,edeheggnehehjfnngbbncdjfdmggj,gkjbgehgealkmedkchbhaki,lnfibnkhfjdmblaea,icjhkjalmnimalcjdina,lgjbkmajnnihdmchcmc,fbigabggegggjckjkknn,haacangamkmejcemdininaekicnijm)
};
...
operator<<(::std::ostream& ost, const NT &rhs) {
	...
	S35 s35; cout << s35 << endl;
	S36 s36; cout << s36 << endl;
	S37 s37; cout << s37 << endl;
	S38 s38; cout << s38 << endl;
	S39 s39; cout << s39 << endl;
return 0;
}